...
.PARAMETER Clean
Removes the image dotnetdocker and kills all containers based on that image.
...
Build a Docker image named dotnetdocker
#>
...
$imageName="dotnetdocker"
$projectName="dotnetdocker"
$serviceName="dotnetdocker"
